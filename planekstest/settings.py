...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(__file__), '../templates/planekstest').replace('\\', '/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
BROKER_URL = 'redis://:p98ee57b101ee894443738f814985b4b093adbca43d64042e65cfca069be4555c@ec2-50-16-128-84.compute-1.amazonaws.com:12099'
